...
public class RechargeRecordTask {
    ...
    public void refreshRecord() throws Exception {
        ...
        try {
            ...
            List<String> collect = addressList.stream().map(Address::getAddress).collect(Collectors.toList());
            XxlJobHelper.log("{}", collect);
            Date now = new Date();
            //查出所有的交易记录哈希
...
//                Date lastTime = address.getCreateTime();
                ...
                XxlJobHelper.log("newRecords:{}", newRecords);
