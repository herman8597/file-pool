...
//    }
    ...
    public ApiResult<Boolean> audit(@RequestBody SysSupplementAuthRequest request) throws Exception {
        boolean flag = supplementService.audit(request.getSupplementId(),request.getIsPass(),request.getRemark());
        return ApiResult.result(flag);
    }
