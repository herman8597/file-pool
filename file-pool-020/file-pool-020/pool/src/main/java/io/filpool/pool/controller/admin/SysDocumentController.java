...
public class SysDocumentController {
    ...
    @ApiOperation("文档中心-删除")
    public ApiResult<Boolean> documentDel(@RequestBody Document document) throws Exception {
        boolean b = documentService.removeById(document.getId());
