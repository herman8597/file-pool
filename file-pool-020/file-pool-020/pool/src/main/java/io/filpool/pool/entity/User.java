...
public class User extends BaseEntity {
    ...
    @ApiModelProperty("市场等级：P1,P2,P3,P4,P5")
    @TableField(exist = false)
    ...
    @ApiModelProperty("XCH技术服务费")
    private BigDecimal xchServerCharge;

    @ApiModelProperty("BZZ技术服务费")
    private BigDecimal bzzServerCharge;
