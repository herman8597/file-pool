...
//    private String img;
    ...
    @Excel(name = "交易类型", width = 30, replace = {"充值_1", "提现_2", "平台充值_3", "平台扣除_4", "gas费_5", "购买矿机_6", "购买云算力_7", "购买矿机集群_8"
            , "奖励返佣_9", "当日挖矿首次释放_10", "当日线性释放_11", "极差奖励 _20", "平级奖励_21"})
    @ApiModelProperty("记录的类型：1充值 2提现 3平台充值 4平台扣除 5gas费 6购买矿机 7购买云算力 8购买矿机集群 9奖励返佣 10当日挖矿首次释放 11当日线性释放 20极差奖励 21平级奖励")
