...
package io.filpool.framework.common.api;
...
public enum ApiCode {
     ...
     * 登录授权异常
     **/
    AUTHENTICATION_EXCEPTION(5104, "登录授权异常或者密码错误"),
    /**
     * 没有访问权限
     **/
    ...
    ACCOUNT_EXITS(5109, "账号已存在"),

    ACCOUNT_NOT_EXITS(5110, "账号不存在"),

    ACCOUNT_PAY_PWD_NOT_SET(5111, "交易密码未设置"),

    GOOGLE_VERIFY_NOT_BIND(5112, "未绑定谷歌验证"),
    ;
