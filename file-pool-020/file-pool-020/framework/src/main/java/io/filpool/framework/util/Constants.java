...
//    public static final String CURRENCY_PERCENT_KEY = "CURRENCY_PERCENT:";
    ...
    public static final String CURRENCY_XCH_KEY = "CURRENCY_XCH_INFO";
    public static final String FIL_INFO = "FIL:INFO";
    /**
     * fil24小时收益
     * */
    public static final String FIL_24H_INCOME = "FIL:24H:INCOME";
    /**
     * XCH24小时收益
     * */
    public static final String XCH_24H_INCOME = "XCH:24H:INCOME";
}
