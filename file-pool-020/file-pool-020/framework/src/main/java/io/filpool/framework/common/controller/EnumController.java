...
public class EnumController {
    ...
    private static final List<String> FRAMEWORK_ENUM_PACKAGES = Arrays.asList(
            "io.filpool.framework.common.enums",
            "io.filpool.system.enums");
