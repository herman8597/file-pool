...
import io.filpool.config.properties.SpringBootPlusFilterProperties;
import io.filpool.config.properties.SpringBootPlusInterceptorProperties;
import io.filpool.config.properties.SpringBootPlusProperties;
import io.filpool.framework.core.filter.RequestDetailFilter;
import io.filpool.framework.core.interceptor.PermissionInterceptor;
import io.filpool.framework.core.xss.XssFilter;
import io.filpool.framework.util.Constants;
import io.filpool.framework.util.IniUtil;
import io.filpool.interceptor.AuthenticationInterceptor;
import io.filpool.system.interceptor.DownloadInterceptor;
import io.filpool.system.interceptor.ResourceInterceptor;
import io.filpool.system.interceptor.UploadInterceptor;
...
public class SpringBootPlusWebMvcConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(authenticationInterceptor())
                .addPathPatterns(Constants.API_PREFIX + "/**");
